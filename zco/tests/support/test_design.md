...
| Header | Unit Test |
|---|---|
| zco/channel.h | tests/unit/channel_unit.cc |
| zco/event.h | tests/unit/event_unit.cc |
| zco/hook.h | tests/unit/hook_unit.cc + tests/unit/hook_metadata_timeout_unit.cc |
| zco/io_event.h | tests/unit/io_event_unit.cc |
| zco/zco_log.h | tests/unit/log_unit.cc |
| zco/mutex.h | tests/unit/mutex_unit.cc |
| zco/pool.h | tests/unit/pool_unit.cc |
| zco/sched.h | tests/unit/sched_unit.cc + tests/unit/runtime_manager_unit.cc |
| zco/wait_group.h | tests/unit/wait_group_unit.cc |
| zco/zco.h | tests/unit/zco_unit.cc |
| zco/internal/coroutine_waiter.h | tests/unit/coroutine_waiter_unit.cc |
| zco/internal/epoller.h | tests/unit/epoller_unit.cc |
| zco/internal/fiber.h | tests/unit/fiber_unit.cc |
| zco/internal/fiber_handle_registry.h | tests/unit/fiber_handle_registry_unit.cc |
| zco/internal/fiber_pool.h | tests/unit/fiber_pool_unit.cc |
| zco/internal/noncopyable.h | tests/unit/noncopyable_unit.cc |
| zco/internal/poller.h | tests/unit/poller_unit.cc |
| zco/internal/processor.h | tests/unit/processor_unit.cc + tests/unit/processor_wait_timer_unit.cc |
| zco/internal/runtime_manager.h | tests/unit/runtime_manager_unit.cc |
| zco/internal/shared_stack_buffer.h | tests/unit/shared_stack_buffer_unit.cc |
| zco/internal/snapshot_buffer_pool.h | tests/unit/snapshot_buffer_pool_unit.cc |
| zco/internal/steal_queue.h | tests/unit/steal_queue_unit.cc |
| zco/internal/timer.h | tests/unit/timer_unit.cc + tests/unit/timer_queue_unit.cc |

Exception by design:
context.h 被视为功能特别简单（仅 ucontext 薄封装），暂不强制独立 *_unit.cc；其行为通过 fiber/processor 路径间接覆盖。

## Coverage Workflow (zco/src only)
...
# Run zco unit + integration only (exclude stress)
...
# Keep zco/src only
lcov --extract coverage.info '*/zco/src/*' --output-file zco-src.info

# Remove system and third-party noise
lcov --remove zco-src.info '/usr/*' '*/extern/*' --output-file zco-src.info
