...
TEST_F(SnapshotBufferPoolUnitTest, DynamicBufferUsesExactCapacityAndSafeRelease) {
  SnapshotBufferPool pool;
...
TEST_F(SnapshotBufferPoolUnitTest, ReleaseWithMismatchedCapacityFallsBackToDeletePath) {
  SnapshotBufferPool pool;
