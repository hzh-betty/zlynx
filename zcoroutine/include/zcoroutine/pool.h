#ifndef ZCOROUTINE_POOL_H_
#define ZCOROUTINE_POOL_H_
...
class PoolGuard {
 public:
   ...
   * @param pool 对象池引用。
   */
  explicit PoolGuard(const Pool& pool) : pool_(pool), element_(static_cast<T*>(pool_.pop())) {}
